...
#     #if they don't exist, 
    if infile[0] == "/":
        ...
        input_raw_dir_base = '/home/scratch/esmith/RFI_MIT/jetstor/scratch/rfimit/unmitigated/rawdata'
...
#     #== output stuff ==
    ...
    output_raw_dir_base = '/home/scratch/esmith/RFI_MIT/jetstor/scratch/rfimit/mitigated/rawdata'
    ...
    output_mit_srdp_dir_base = '/home/scratch/esmith/RFI_MIT/jetstor/scratch/rfimit/mitigated/reduced'
