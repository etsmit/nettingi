...
PATH_DOCS_STATIC = os.path.join(PATH_DOCS_ROOT, "static")
PATH_DOCS_TEMPLATES = os.path.join(PATH_DOCS_ROOT, "templates")
...
# Project information
URL_GITHUB = config.get('Project', 'url')
...
htmlhelp_basename = "RFIMitigationDoc"
